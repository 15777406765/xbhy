...
CREATE TABLE `menu`  (
  ...
  `type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '一级菜单=1，二级菜单=2，三级菜单=3',
...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, -1, '1', '系统管理', NULL, NULL);
INSERT INTO `menu` VALUES (2, -1, '1', '权限管理', NULL, NULL);
INSERT INTO `menu` VALUES (3, 1, '2', '用户管理', '/user/list', NULL);
INSERT INTO `menu` VALUES (4, 1, '2', '文章管理', '/article/list', NULL);
INSERT INTO `menu` VALUES (8, 2, '2', '角色管理', NULL, NULL);
INSERT INTO `menu` VALUES (9, 2, '2', '用户权限', NULL, NULL);
